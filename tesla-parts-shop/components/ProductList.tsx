...
const ProductList: React.FC<ProductListProps> = ({ products, currency, onAddToCart, title }) => {
    ...
    <div className="py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {products.map((product) => (
          <div key={product.id} className="bg-white rounded-xl shadow-sm hover:shadow-md transition border border-gray-100 overflow-hidden flex flex-col">
            ...
            <div className="p-4 flex-1 flex flex-col">
              ...
              <div className="mt-auto pt-4 flex items-center justify-between">
                <div className="text-lg font-bold text-tesla-dark">
